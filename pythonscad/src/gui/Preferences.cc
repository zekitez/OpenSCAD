...
void Preferences::init()
{
  ...
  this->defaultmap["advanced/customizerCollapseTabs"] = false;     // Zekitez
...
void Preferences::on_checkBoxCollapseCustomizerTabs_toggled(bool state)    // Zekitez
{
  QSettingsCached settings;
  settings.setValue("advanced/customizerCollapseTabs", state);
  emit collapseTabsChanged(state);
}
...
void Preferences::updateGUI()
{
  ...
  BlockSignals<QCheckBox *>(this->checkBoxCollapseCustomizerTabs)                      // Zekitez
    ->setChecked(getValue("advanced/customizerCollapseTabs").toBool());
