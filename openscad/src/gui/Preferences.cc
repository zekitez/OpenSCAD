...
void Preferences::init()
{
  ...
  this->defaultmap["advanced/customizerCollapseTabs"] = false;
...
void Preferences::on_checkBoxCollapseCustomizerTabs_toggled(bool state)
{
  QSettingsCached settings;
...
void Preferences::updateGUI()
{
  ...
  BlockSignals<QCheckBox *>(this->checkBoxCollapseCustomizerTabs)
